 ...
 *
 * See [AllsetTextFieldDefaults.textFieldColors] for the default colors used in [TextField].
 * See [AllsetTextFieldDefaults.outlinedTextFieldColors] for the default colors used in
 * [OutlinedTextField].
 */
@Stable
interface AllsetTextFieldColors {
  /**
...
interface AllsetTextFieldColorsWithIcons : AllsetTextFieldColors {
  /**
   * Represents the color used for the leading icon of this text field.
   *
   * @param enabled whether the text field is enabled
 ...
 */
@Immutable
object AllsetTextFieldDefaults {
  /**
   ...
   * @param interactionSource the [InteractionSource] of this text field. Helps to determine if
   * the text field is in focus or not
   * @param colors [AllsetTextFieldColors] used to resolve colors of the text field
  ...
  fun textFieldWithLabelPadding(
    start: Dp = TextFieldStartPadding,
    end: Dp = TextFieldEndPadding,
  ...
  /**
   * Creates a [AllsetTextFieldColors] that represents the default input text, background and content
  ...
  ): AllsetTextFieldColors =
    DefaultAllsetTextFieldColors(
      textColor = textColor,
   ...
   * container
   * @param colors [AllsetTextFieldColors] that will be used to resolve color of the text and content
   * (including label, placeholder, leading and trailing icons, bottom indicator) for this text field in
   * different states. See [AllsetTextFieldDefaults.textFieldColors]
   ...
   * control horizontal padding. See [AllsetTextFieldDefaults.textFieldWithLabelPadding] and
   * [AllsetTextFieldDefaults.textFieldWithoutLabelPadding]
  ...
  fun TextFieldDecorationBox(
    ...
    colors: AllsetTextFieldColors = textFieldColors(),
   ...
   * different states. See [AllsetTextFieldDefaults.outlinedTextFieldColors]
   ...
   * @param contentPadding the spacing values to apply internally between the internals of text field
   * and the decoration box container. You can use it to implement dense text fields or simply to
   * control horizontal padding. See [AllsetTextFieldDefaults.outlinedTextFieldPadding]
   */
  @Composable
  @ExperimentalMaterialApi
  fun OutlinedTextFieldDecorationBox(
    ...
    leadingIcon: @Composable (() -> Unit)? = null,
    trailingIcon: @Composable (() -> Unit)? = null,
    colors: AllsetTextFieldColors = outlinedTextFieldColors(),
...
@Immutable
private class DefaultAllsetTextFieldColors(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    other as DefaultAllsetTextFieldColors
