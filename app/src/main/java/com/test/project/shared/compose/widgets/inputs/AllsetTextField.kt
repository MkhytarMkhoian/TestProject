...
import com.test.project.shared.compose.widgets.inputs.AllsetTextFieldDefaults.indicatorLine
 ...
 *
 * If you are looking for an outlined version, see [AllsetOutlinedTextField].
 *
 ...
 * @param enabled controls the enabled state of the [AllsetTextField]. When `false`, the text field will
 * be neither editable nor focusable, the input of the text field will not be selectable,
 * visually text field will appear in the disabled UI state
 * @param readOnly controls the editable state of the [AllsetTextField]. When `true`, the text
 ...
 * @param colors [AllsetTextFieldColors] that will be used to resolve color of the text, content
 * (including label, placeholder, leading and trailing icons, indicator line) and background for
 * this text field in different states. See [AllsetTextFieldDefaults.textFieldColors]
 */
@Composable
fun AllsetTextField(
    value: String,
    ...
    colors: AllsetTextFieldColors = AllsetTextFieldDefaults.textFieldColors()
) {
    ...
    BasicTextField(
        ...
        modifier = modifier
            ...
            .defaultMinSize(
                minWidth = AllsetTextFieldDefaults.MinWidth,
                minHeight = AllsetTextFieldDefaults.MinHeight
            ),
        ...
        decorationBox = @Composable { innerTextField ->
            ...
            AllsetTextFieldDefaults.TextFieldDecorationBox(
                value = value,
                visualTransformation = visualTransformation,
 ...
 * [AllsetTextField] when there is a label. When there is no label, [placeWithoutLabel] is used.
 */
...
/**
 * Places the provided text field and placeholder in [AllsetTextField] when there is no label. When
...
/**
 * A draw modifier that draws a bottom indicator line in [AllsetTextField]
 */
...
internal val FirstBaselineOffset = 32.dp

/** Padding from input field to the start */
internal val TextFieldStartPadding = 24.dp

/** Padding from input field to the end */
internal val TextFieldEndPadding = 24.dp
