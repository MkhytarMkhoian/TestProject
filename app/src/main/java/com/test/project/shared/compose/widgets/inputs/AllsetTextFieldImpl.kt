...
import com.test.project.shared.compose.widgets.inputs.Strings.Companion.DefaultErrorMessage
...
/**
 * Implementation of the [AllsetTextField] and [AllsetOutlinedTextField]
 */
...
internal fun CommonDecorationBox(
    ...
    TextFieldTransitionScope.Transition(
        ...
        val leadingIconColor = if (colors is AllsetTextFieldColorsWithIcons) {
        ...
        val trailingIconColor = if (colors is AllsetTextFieldColorsWithIcons) {
