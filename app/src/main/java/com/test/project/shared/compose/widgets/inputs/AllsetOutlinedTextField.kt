 ...
 *
 * See example usage:
 * @sample samples.SimpleOutlinedTextFieldSample
 *
 ...
 * @param enabled controls the enabled state of the [AllsetOutlinedTextField]. When `false`, the text field will
 * be neither editable nor focusable, the input of the text field will not be selectable,
 * visually text field will appear in the disabled UI state
 * @param readOnly controls the editable state of the [AllsetOutlinedTextField]. When `true`, the text
...
fun AllsetOutlinedTextField(
    ...
    BasicTextField(
        ...
        decorationBox = @Composable { innerTextField ->
            AllsetTextFieldDefaults.OutlinedTextFieldDecorationBox(
                value = value,
                visualTransformation = visualTransformation,
                ...
                colors = colors,
                border = {
                    AllsetTextFieldDefaults.BorderBox(
                        enabled,
                        isError,
                        interactionSource,
                        colors,
 ...
 *
 * See example usage:
 * @sample samples.OutlinedTextFieldSample
 *
...
fun AllsetOutlinedTextField(
    ...
    maxLines: Int = Int.MAX_VALUE,
    interactionSource: MutableInteractionSource = remember { MutableInteractionSource() },
    shape: Shape = AllsetTextFieldDefaults.OutlinedTextFieldShape,
    colors: AllsetTextFieldColors = AllsetTextFieldDefaults.outlinedTextFieldColors()
) {
    // If color is not provided via the text style, use content color as a default
    val textColor = textStyle.color.takeOrElse {
...
/**
 * Calculate the width of the [AllsetOutlinedTextField] given all elements that should be
 * placed inside
 */
...
/**
 * Calculate the height of the [AllsetOutlinedTextField] given all elements that should be
 * placed inside
 */
